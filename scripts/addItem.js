...
// function trackItemsAdded() {
//   let countItems = 0;
//   const itemsIn = document.querySelector(".count-items");
//   const basketItems = document.querySelector(".basket-items");
//   if (basketItems.childElementCount === 0) {
//     itemsIn.style.opacity = "0";
//   } else if (basketItems.childElementCount > 0) {
//     itemsIn.style.opacity = "1";
//     countItems = basketItems.childElementCount;
//     console.log(countItems);
//     itemsIn.textContent = basketItems.childElementCount - 1;
//   } else {
...
//       targetItemToRemove(e.target);
//     });
//   });
// }

// function targetItemToRemove(element) {
//   const itemToRemove = element.closest(".new-item-container");
...
//         ".price-received"
//       ).textContent;
//     const sepratePrice = parseFloat(itemPrice.replace("$", ""));

//     const priceIndex = cartTotal.indexOf(sepratePrice);
//     if (priceIndex !== -1) {
//       cartTotal.splice(priceIndex, 1);
//     }
//     itemToRemove.remove();
